...
/**
 * MTKProximitySensor manages functions related to the proximity sensor in
 * the AppRTC demo.
 ...
 */
public class MTKProximitySensor implements SensorEventListener {
    private static final String TAG = "MTKProximitySensor";
    ...
    /** Construction */
    static MTKProximitySensor create(Context context, Runnable sensorStateListener) {
        return new MTKProximitySensor(context, sensorStateListener);
    }
