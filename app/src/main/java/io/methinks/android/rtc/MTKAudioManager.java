...
public class MTKAudioManager {
    private static final String TAG = "MTKAudioManager";
    ...
    private MTKProximitySensor proximitySensor = null;

    // Handles all tasks related to Bluetooth headset devices.
    private final MTKBluetoothManager bluetoothManager;
    ...
    /** Construction. */
    static MTKAudioManager create(Context context) {
        return new MTKAudioManager(context);
    }
    ...
    private MTKAudioManager(Context context) {
        ...
        bluetoothManager = MTKBluetoothManager.create(context, this);
...
//        useSpeakerphone = sharedPreferences.getString(context.getString(R.string.pref_speakerphone_key), context.getString(R.string.pref_speakerphone_default));
    ...
    public void updateAudioDeviceState() {
        ...
        if (bluetoothManager.getState() == MTKBluetoothManager.State.HEADSET_AVAILABLE
                || bluetoothManager.getState() == MTKBluetoothManager.State.HEADSET_UNAVAILABLE
                || bluetoothManager.getState() == MTKBluetoothManager.State.SCO_DISCONNECTING) {
        ...
        if (bluetoothManager.getState() == MTKBluetoothManager.State.SCO_CONNECTED
                || bluetoothManager.getState() == MTKBluetoothManager.State.SCO_CONNECTING
                || bluetoothManager.getState() == MTKBluetoothManager.State.HEADSET_AVAILABLE) {
        ...
        if (bluetoothManager.getState() == MTKBluetoothManager.State.HEADSET_UNAVAILABLE
