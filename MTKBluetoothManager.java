...
/**
 * MTKProximitySensor manages functions related to Bluetoth devices in the
 * AppRTC demo.
 */
public class MTKBluetoothManager {
    private static final String TAG = "MTKBluetoothManager";
    ...
    private final MTKAudioManager apprtcAudioManager;
